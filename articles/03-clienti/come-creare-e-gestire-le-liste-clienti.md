...
collection_id: 7180
collection: "👨‍👩‍👧‍👦 Clienti"
title: "Come creare e gestire le Liste Clienti"
slug: come-creare-e-gestire-le-liste-clienti
description: "Crea gruppi personalizzati di clienti per inviare campagne mirate, costruire livelli fedeltà e molto altro."
status: published
written_by: 2961
keywords:
  - liste clienti
...
![Menù a tendina con le liste preimpostate e una lista personalizzata](https://up-kb-assets.s3.eu-west-3.amazonaws.com/03-clienti/61968_TendinaListe-ClientiAltoSpendenti.jpg)
...
Il bottone è in alto a destra. Imposta i filtri che definiscono il tuo gruppo (vedi [Filtra Clienti: come segmentare e analizzare i tuoi clienti](https://supporto.unipiazza.it/it/articles/61967-filtra-clienti-come-segmentare-e-analizzare-i-tuoi-clienti) per la lista completa dei filtri disponibili).
...
![Finestra Salva Lista con conteggio clienti e filtri applicati](https://up-kb-assets.s3.eu-west-3.amazonaws.com/03-clienti/61968_SalvaLista-Modal.jpg)
...
Per scoprire altre idee, leggi [15 idee per segmentare i clienti con i filtri](https://supporto.unipiazza.it/it/articles/61969-15-idee-per-segmentare-i-clienti-con-i-filtri). 💡
